...
public class Admin extends Member implements java.io.Serializable {
	private static final long serialVersionUID = 7867665L;
	   private String id;
	   public String getId() {
		return id;
	}
	...
	public String toString() {
		return "Admin [id=" + id + ", name=" + name + ", ssn=" + ssn + ", address=" + address + ", phone=" + phone
	...
	public Admin(String id, String name, String ssn, String address, String phone, String gender, String email,
