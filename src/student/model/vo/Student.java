...
public class Student extends Member implements java.io.Serializable {
   private static final long serialVersionUID = 4577455L;
   private String id;
   private String name;
   private String ssn;
...
public Student(String id, String name, String ssn, String address, String phone, String gender, String email,
...
public String toString() {
	return "Student [id=" + id + ", name=" + name + ", ssn=" + ssn + ", address=" + address + ", phone=" + phone
			+ ", gender=" + gender + ", email=" + email + ", treasure=" + treasure + ", categoryname=" + categoryname
			+ ", majorno=" + majorno + ", entrancedate=" + entrancedate + ", absencewhether=" + absencewhether
			+ ", absencecount=" + absencecount + ", ssname=" + ssname + ", password=" + password + "]";
}
