...
<body>
 ...
 %>
	...
	<button onclick="javascript:location.href='/beet/nupdate.ad1?noticeno=<%= notice.getNoticeNo() %>';">수정</button>
	<button onclick="javascript:location.href='/beet/ndelete.ad?noticeno=<%= notice.getNoticeNo()%>';">삭제하기</button>
	</div>
