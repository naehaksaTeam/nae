...
<body>
	...
	<div style align="center">
		...
		<button
			onclick="javascript:location.href='/beet/mupdate?majorno=<%=major.getMajorno()%>';">수정</button>
		<button
			onclick="javascript:location.href='/beet/mdelete?majorno=<%=major.getMajorno()%>';">삭제</button>
	</div>
