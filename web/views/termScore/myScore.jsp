...
<br>
<br>
<p><strong>≫ 학기 성적조회</strong></p>	
<table class="main_default" id="tg-1">
				<thead>
					<tr>
						<th>학년학기</th>
						<th>신청학점</th>
...
<script type="text/javascript" src="/beet/resources/js/jquery-3.5.1.min.js"></script>
	...
	jQuery('input[name=semester]').attr('value',td.eq(0).text());
	jQuery("#reload").submit();
	jQuery("#split").show();
	})
