...
<h4 style="margin-bottom: 10px; padding-left: 25px;"><%=membermm.getName() %> 님의 신청내역 조회</h4>
...
<% }else if(membermm.getAbsencewhether().equals("N")){ %>

<tr>
	<th>
		현재 <%=membermm.getName() %>님은 재학상태입니다
	</th>
</tr>
<tr>
	<td>
...
<tr>
	...
	<p style="text-align: center;"><strong>
		<a class="down_default" href="/beet/insertab?value=a&studentid=<%=membermm.getId()%>" target="_blank">휴학신청</a>
	</strong></p>		
	</td>
</tr>
<% } %>
