...
<table class="main_default" id="disup" align="center" width="1000" cellspacing="5" cellpadding="0">
<tr>
<th>번호</th>
...
<tr>
	<th colspan="4" >
		...
		<button class="btn btn-outline-secondary" type="reset" onclick="javascript:history.go(-1); return false;">작성취소</button> &nbsp;&nbsp;
