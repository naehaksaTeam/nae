...
<table class="main_default">
  ...
  <tr>
	...
	<td>&nbsp;
	<button class="btn btn-outline-secondary" onclick="javascript:location.href='/beet/schdetail?scheduleid=<%=s.getScheduleid() %>';">수정</button>&nbsp; 
...
<tr>
	<th>일정 내용</th>
	<td style="text-align: left;"><textarea rows="5" cols="70" name="schname"></textarea></td></tr>
<tr>
	<th colspan="3" >

		
		<button class="btn btn-outline-secondary" type="submit">등록하기</button> &nbsp;&nbsp;
		<button class="btn btn-outline-secondary" type="reset" onclick="disc()">작성취소</button> &nbsp;&nbsp;
