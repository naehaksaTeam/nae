...
/* 퀵메뉴 */
#quick_menu_area{position:absolute;top:133px;right:-109px;width:90px;margin-bottom:8px;background:#1866a6;box-sizing:border-box}
#quick_menu_area h2{height:29px;background:#097cc9;color:#fff;font-size:13px;text-align:center;line-height:29px;font-weight:normal}
#quick_menu_area ul{position:relative;width:100%;text-align:center}
#quick_menu_area ul li{display:block;height:90px;color:#fff;font-size:12px;text-align:center;cursor:pointer;letter-spacing:-1px}
#quick_menu_area ul li span{display:block;width:100%;margin-top:-30px;color:#dee4eb;font-size:12px;text-align:center;letter-spacing:-1px;cursor:pointer}
#quick_menu_area ul li a{color:#dee4eb;border-bottom:solid 1px #4984b5}
#quick_menu_area ul a:hover li{margin-top:12px;text-decoration:none}
#quick_menu_area ul .quick_ico01{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico01.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico02{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico02.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico03{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico03.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico04{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico04.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico05{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico05.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico06{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico06.png") no-repeat 50% 50%}
#quick_menu_area ul .quick_ico07{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico07.png") no-repeat 50% 50%}

/* 퀵메뉴 */
#quick_menu_area2 {position:absolute;top:133px;right:-109px;width:90px;margin-bottom:8px;background:#1866a6;box-sizing:border-box}
#quick_menu_area2 h2{height:29px;background:#097cc9;color:#fff;font-size:13px;text-align:center;line-height:29px;font-weight:normal}
#quick_menu_area2 ul{position:relative;width:100%;text-align:center}
#quick_menu_area2 ul li{display:block;height:90px;color:#fff;font-size:12px;text-align:center;cursor:pointer;letter-spacing:-1px}
#quick_menu_area2 ul li span{display:block;width:100%;margin-top:60px;color:#dee4eb;font-size:12px;text-align:center;letter-spacing:-1px;cursor:pointer}
#quick_menu_area2 ul li a{color:#dee4eb;border-bottom:solid 1px #4984b5}
#quick_menu_area2 ul a:hover li{margin-top:12px;text-decoration:none}
#quick_menu_area2 ul .quick_ico01{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico01.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico02{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico02.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico03{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico03.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico04{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico04.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico05{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico05.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico06{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico06.png") no-repeat 50% 50%}
#quick_menu_area2 ul .quick_ico07{display:inline-block;width:90px;height:89px;background:url("https://portal.hywoman.ac.kr/eXPortal/portalresources/theme/css/../images/hyw/quick_menu_ico07.png") no-repeat 50% 50%}
...
<div id="top_wrap">
	...
	<div class="GNB">
		...
		<ul>
			...
			<li class="time" id="sessionTimer" style="color:#8f8f8f;">04:39:04</li>
	...
	<div class="major_menu_area">
		<ul class="main_menu01">
			<li class="first" style="width:1155px;">
						<a href="/p/20000/" target="_blank">내학사</a>
							</li>
			...
			<div id="content_main_top">
				<ul>
					<li class="indiv_area">
						...
						<div class="indiv_info">
							...
							<ul class="info_01">
								...
								<li class="time2" id="currentTime">현재시간 : 2020년 8월 13일 14시 25분 42초</li>
				    ...
				    <div class="lecture_area">
					    ...
					    <ul class="btn02" style="position: relative;top: -32px;right: -3px;text-align: center;float: right;"><li id="pageBtn0" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="schPageChange(this);" page-index="0" style="cursor:pointer;"></a></li><li id="pageBtn1" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="schPageChange(this);" page-index="1" style="cursor:pointer;"></a></li></ul>
...
function throwMe(val){var throwable=false;if(typeof portletThrowCheck!='undefined'){throwable=portletThrowCheck();}else{throwable=confirm(Msg.throwportletconfirm);}
if(throwable){var element=document.getElementById(val);element.parentNode.removeChild(element);if(typeof saveDisplay!='undefined'){saveDisplay(false);}}}
function appendPortletScript(data){if(data){var head=document.getElementsByTagName('head')[0];var script=document.createElement('script');script.type='text/javascript';script.src=data;head.appendChild(script);}}
function appendPortletFunction(data){if(data){if(window.execScript){window.execScript(data,"javascript");}else{window.eval(data);}}}
function appendPortletContent(tagId,data){var vCont=document.getElementById(tagId);if(vCont){vCont.innerHTML=data;}}
function mergePortletContent(tagId,data){var vCont=document.getElementById(tagId);if(vCont){var voDiv=document.createElement("div");voDiv.innerHTML=data;vCont.appendChild(voDiv);}}
function setTitle(tagId,data){var vCont=document.getElementById(tagId);if(vCont){vCont.innerHTML=data;}}
function setVisibleBtn(val){var divs=val.getElementsByTagName('div');for(var i=0;i<divs.length;i++){var div=divs[i];if(div.className=='portlet-icon'){div.style.display='';setOpacity(100,div.style);break;}}}
function setInvisibleBtn(val){var divs=val.getElementsByTagName('div');for(var i=0;i<divs.length;i++){var div=divs[i];if(div.className=='portlet-icon'){setOpacity(1,div.style);break;}}}
function setOpacity(opacity,object){if(navigator.userAgent.search("Firefox")!=-1){if(opacity==100){opacity=99.999;}}
object.filter="alpha(opacity="+opacity+")";object.KhtmlOpacity=(opacity/100);object.opacity=(opacity/100);object.MozOpacity=(opacity/100);}
function chkFileExtenstion(fileNm){var urlIdx=fileNm.lastIndexOf(".")+1;var extention=fileNm.substr(urlIdx);return extention;}

</script>

<script type="text/javascript">

var exportal={};exportal.portlets={};exportal.contextPath="/";exportal.url="";exportal.eventHandler={};function PortletInfo(){this.status=null;this.mode=null;this.renderParam=null;};exportal.setContextPath=function(contextPath){if(typeof contextPath=="undefined"||contextPath==null||contextPath==""){return;}
exportal.contextPath=contextPath;};exportal.getPortlet=function(id){var portlet=exportal.portlets[id];if(typeof portlet=="undefined"||portlet==null){portlet=new PortletInfo();}
return portlet;};exportal.addEventHandler=function(eventId,handler){if(!exportal.eventHandler[eventId]){exportal.eventHandler[eventId]=new Array();}
exportal.eventHandler[eventId].push(handler);};exportal.getEventHandler=function(eventId){if(!exportal.eventHandler[eventId]){return null;}
var eventHandler=exportal.eventHandler[eventId].pop();exportal.eventHandler[eventId].unshift(eventHandler);return eventHandler;}
exportal.setPortlet=function(id,portlet){exportal.portlets[id]=portlet;};exportal.updateStatus=function(id,status){var portlet=exportal.getPortlet(id);if(status=="normal"){portlet.status=null;}else{portlet.status=status;}
exportal.setPortlet(id,portlet);};exportal.getStatus=function(id){var portlet=exportal.getPortlet(id);if(portlet.status){return portlet.status;}else{return"normal";}};exportal.updateMode=function(id,mode){var portlet=exportal.getPortlet(id);if(mode=="view"){portlet.mode=null;}else{portlet.mode=mode;}
exportal.setPortlet(id,portlet);};exportal.getMode=function(id){var portlet=exportal.getPortlet(id);if(portlet.mode){return portlet.mode;}else{return"view";}};exportal.addRenderParam=function(id,name,value){var portlet=exportal.getPortlet(id);if(typeof portlet.renderParam=="undefined"||portlet.renderParam==null){portlet.renderParam="";}
portlet.renderParam+="/__rp"+id+"_"+name+"/"+encodeURIComponent(value);exportal.setPortlet(id,portlet);};exportal.clearRenderParam=function(id){var portlet=exportal.getPortlet(id);portlet.renderParam="";exportal.setPortlet(id,portlet);};exportal.clearAllRenderParam=function(){for(var id in exportal.portlets){exportal.portlets[id].renderParam="";}};exportal.toURL=function(){var url=exportal.url;for(var id in exportal.portlets){var portlet=exportal.portlets[id];url+=exportal.toPortletURL(id,portlet);}
var pattern=/\/+/g;return url.replace(pattern,"/");};exportal.toPortletURL=function(id,portlet){var url="";if(portlet.mode){url+="/__pm"+id+"_"+portlet.mode;}
if(portlet.status){url+="/__ws"+id+"_"+portlet.status;}
if(portlet.renderParam){url+=portlet.renderParam;}
return url;};exportal.getResourceUrl=function(portletId,resourceId){var portlet=exportal.getPortlet(portletId);var url=exportal.url;if(portlet.mode){url+="/__pm"+portletId+"_"+portlet.mode;}
if(portlet.status){url+="/__ws"+portletId+"_"+portlet.status;}
url+="/__rs"+portletId+"/__ri";if(resourceId){url+=resourceId;}else{url+=exportal.getMode(portletId);}
if(portlet.renderParam){url+=portlet.renderParam;}
var pattern=/\/+/g;return url.replace(pattern,"/");};exportal.getActionUrl=function(portletId,actionId){var portlet=exportal.getPortlet(portletId);var url=exportal.url;if(portlet.mode){url+="/__pm"+portletId+"_"+portlet.mode;}
if(portlet.status){url+="/__ws"+portletId+"_"+portlet.status;}
url+="/__ac"+portletId;if(portlet.renderParam){url+=portlet.renderParam;}
url+="?javax.portlet.action="+actionId;var pattern=/\/+/g;return url.replace(pattern,"/");};exportal.actionSubmit=function(portletId,actionId,formName,callBack,errorCallBack){exportal.ajaxSubmit({type:"post",async:false,url:exportal.getActionUrl(portletId,actionId),data:$("#"+formName).serialize(),success:function(data){if(callBack){callBack(data);}else if(data&&data!=""){try{eval(data);}catch(e){}}},error:function(jqXHR,textStatus,errorThrown){var statusCode=jqXHR.status;if(statusCode=="401"||statusCode=="403"){var rtnObj=$.parseJSON(jqXHR.responseText);if(rtnObj&&rtnObj.AJAXMsg){alert(rtnObj.AJAXMsg);}
window.location=exportal.contextPath;return;}
if(errorCallBack){errorCallBack(jqXHR,textStatus,errorThrown);}}});};exportal.renderSubmit=function(portletId,mode,callBack,errorCallBack){var resultMsg;exportal.updateMode(portletId,mode);exportal.ajaxSubmit({type:"get",async:false,url:exportal.getResourceUrl(portletId),data:null,success:function(data){if(callBack){callBack(data);}else{$("#"+exportal.getPtlId(portletId)).html(data);}},error:function(jqXHR,textStatus,errorThrown){var statusCode=jqXHR.status;if(statusCode=="401"||statusCode=="403"){var rtnObj=$.parseJSON(jqXHR.responseText);if(rtnObj&&rtnObj.AJAXMsg){alert(rtnObj.AJAXMsg);}
window.location=exportal.contextPath;return;}
if(errorCallBack){errorCallBack(jqXHR,textStatus,errorThrown);}}});};exportal.getPtlId=function(portletId){var pattern=/!|-|\|/g;portletId=portletId.replace(pattern,"_");return"AjaxPtlBody"+"eXPortal_"+portletId+"_";};exportal.resize=function(portletId,state){var currentState=exportal.getStatus(portletId);if(currentState==state){return;}
exportal.updateStatus(portletId,state);if(state=="maximized"){document.location=exportal.toURL();}else if(state=="normal"&&currentState=="minimized"){exportal.ajaxSubmit({type:"post",async:false,url:exportal.getResourceUrl(portletId),data:null,success:function(data){$("#"+exportal.getPtlId(portletId)).html(data);},error:function(data){resultMsg=data;}});}else if(state=="normal"&&currentState=="maximized"){document.location=exportal.toURL();}else if(state=="minimized"&&currentState=="maximized"){document.location=exportal.toURL();}else if(state=="minimized"&&currentState=="normal"){var div=document.getElementById(exportal.getPtlId(portletId));if(div.hasChildNodes()){while(div.childNodes.length>=1){div.removeChild(div.firstChild);}}}else{}};exportal.resizeNow=function(portletId,state){var currentState=exportal.getStatus(portletId);if(currentState==state){return;}
exportal.updateStatus(portletId,state);document.location=exportal.toURL();};exportal.updateModeNow=function(portletId,mode){var currentMode=exportal.getMode(portletId);if(currentMode==mode){return;}
exportal.updateMode(portletId,mode);document.location=exportal.toURL();};exportal.ajaxSubmit=function(options){if(options.error===undefined){options.error=function(jqXHR,textStatus,errorThrown){var statusCode=jqXHR.status;if(statusCode=="401"||statusCode=="403"){var rtnObj=$.parseJSON(jqXHR.responseText);if(rtnObj&&rtnObj.AJAXMsg){alert(rtnObj.AJAXMsg);}
window.location=exportal.contextPath;return;}};}
$.ajax(options);};exportal.getMsg=function(data){var str=Msg[data];if(str==null||str.length==0){return data;}else{return str;}}

exportal.setContextPath('');exportal.updateStatus('NoticelistPortlet!ds7xq2|0', 'normal');exportal.updateMode('NoticelistPortlet!ds7xq2|0', 'view');exportal.updateStatus('NewArrBookPortlet!ds7xq2|1', 'normal');exportal.updateMode('NewArrBookPortlet!ds7xq2|1', 'view');exportal.updateStatus('WeatherPortlet2!ds7xq2|2', 'normal');exportal.updateMode('WeatherPortlet2!ds7xq2|2', 'view');exportal.url = '/p/10011/';
...
<li class="item yui3-dd-drop yui3-dd-draggable" id="NoticelistPortlet!ds7xq2|0"><div class="mod">
        ...
        <div class="portlet-icon">
              ...
              <a title="열기" href="#none" id="eXPortal_NoticelistPortlet_ds7xq2_0_ShowDiv" onclick="javascript:eXPortal_NoticelistPortlet_ds7xq2_0_ptlDetail();" style="float:left;"></a>
            
          
          
            
              <a title="삭제" onclick="javascript:throwMe('NoticelistPortlet!ds7xq2|0');" href="#none"></a>
...
<div id="eXPortal_NoticelistPortlet_ds7xq2_0_copyLi" style="display:none;">
  </div></div></div></div></div></li><li data-post-url="/ctt/bb/bulletin?b=3&amp;p=53" onclick="javascript:eXPortal_NoticelistPortlet_ds7xq2_0_movePostDetail(this);">
    <dl>
      <dt><a href="#" data-name="postTitle" title="무선인터넷 서비스 단절 공지">무선인터넷 서비스 단절 공지</a></dt>
      <dd data-name="postCredt">2018.09.13</dd>
    </dl>
...
<li class="item yui3-dd-drop yui3-dd-draggable" id="NewArrBookPortlet!ds7xq2|1"><div class="mod">
        ...
        <div class="portlet-icon">
              ...
              <a title="열기" href="#none" id="eXPortal_NewArrBookPortlet_ds7xq2_1_ShowDiv" onclick="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_ptlDetail();" style="float:left;"></a>
            
          
          
            
              <a title="삭제" onclick="javascript:throwMe('NewArrBookPortlet!ds7xq2|1');" href="#none"></a>
...
<div class="book-wrap" style="margin:15px auto;margin-left:10px;">
	<div class="bx-wrapper-book">
		<ul id="eXPortal_NewArrBookPortlet_ds7xq2_1_bxslider-book" style="width:122%;"><li><a href="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_newBookBrowser(124577)"><img src="https://bookthumb-phinf.pstatic.net/cover/163/483/16348326.jpg?type=m1&amp;udate=20200718" title="성숙한 어른이 갖춰야 할 좋은 심리 습관" alt="11번째 책" style="width:77px; height:100px"></a></li><li><a href="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_newBookBrowser(124576)"><img src="https://bookthumb-phinf.pstatic.net/cover/164/161/16416141.jpg?type=m1&amp;udate=20200807" title="부의 대이동" alt="12번째 책" style="width:77px; height:100px"></a></li><li><a href="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_newBookBrowser(124573)"><img src="https://bookthumb-phinf.pstatic.net/cover/163/975/16397538.jpg?type=m1&amp;udate=20200724" title="당신 지식의 한계 세계관" alt="13번째 책" style="width:77px; height:100px"></a></li><li><a href="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_newBookBrowser(124571)"><img src="https://bookthumb-phinf.pstatic.net/cover/163/807/16380760.jpg?type=m1&amp;udate=20200623" title="클래식 수업. 4 : 헨델, 멈출 수 없는 노래" alt="14번째 책" style="width:77px; height:100px"></a></li><li><a href="javascript:eXPortal_NewArrBookPortlet_ds7xq2_1_newBookBrowser(124570)"><img src="https://bookthumb-phinf.pstatic.net/cover/163/807/16380761.jpg?type=m1&amp;udate=20200623" title="클래식 수업. 3 : 바흐, 세상을 품은 예술의 수도사" alt="15번째 책" style="width:77px; height:100px"></a></li></ul>
		
	</div>
	<div style="height:100px;"></div>
	<div style="text-align:center;">
		<ul id="eXPortal_NewArrBookPortlet_ds7xq2_1_bxslider-book-btn" style="display:inline-block;"><li id="bookBtn0" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="getBook(this);" page-index="0" style="cursor:pointer;"><img src="/eXPortal/images/bl.png" alt="01"></a></li><li id="bookBtn1" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="getBook(this);" page-index="1" style="cursor:pointer;"><img src="/eXPortal/images/bl.png" alt="01"></a></li><li id="bookBtn2" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="getBook(this);" page-index="2" style="cursor:pointer;"><img src="/eXPortal/images/bl_on.png" alt="01"></a></li><li id="bookBtn3" style="display:inline-block;float:left;margin-right:10px;text-align:center;"><a onclick="getBook(this);" page-index="3" style="cursor:pointer;"><img src="/eXPortal/images/bl.png" alt="01"></a></li></ul>
	</div>
...
</ul><ul class="list yui3-dd-drop" id="list3" style="margin-right:-40px;min-height:100%;width:394px">
...
<li class="item yui3-dd-drop yui3-dd-draggable" id="WeatherPortlet2!ds7xq2|2"><div class="mod">
        ...
        <div class="portlet-icon">
              ...
              <a title="삭제" onclick="javascript:throwMe('WeatherPortlet2!ds7xq2|2');" href="#none"></a>
        ...
        <div class="eXPortal_WeatherPortlet2_ds7xq2_2_ep-skyCondition-info">
            ...
            <div class="eXPortal_WeatherPortlet2_ds7xq2_2_ep-skyCondition-info-left">
                <div class="eXPortal_WeatherPortlet2_ds7xq2_2_ep-skyCondition-info-icon" style="position: relative; width: 107px; height: 102px; overflow: hidden;">
                    ...
                    <div class="pm10" style="position: absolute; top: -1.72399px; left: 0px; display: block; z-index: 2; opacity: 1; width: 100px;">
                    ...
                    <div class="pm25" style="position: absolute; top: 100.276px; left: 0px; display: block; z-index: 3; opacity: 1; width: 100px;">
...
</strong><div id="jstree-marker" style="display: none;">»</div><div id="jstree-marker-line" style="display: none;"></div><div id="vakata-contextmenu"></div></body><whale-quicksearch translate="no"></whale-quicksearch></html>